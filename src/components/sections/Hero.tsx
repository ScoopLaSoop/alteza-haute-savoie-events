  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0">
        <div 
          className="absolute inset-0 bg-cover bg-center bg-no-repeat transform scale-110 transition-all duration-[8000ms] ease-in-out"
        ...
        <div className="absolute inset-0">
          ...
          <div className="absolute top-1/3 right-1/3 w-1 h-1 bg-primary/20 rounded-full animate-float" style={{ animationDelay: '2s' }} />
      ...
      <div className="relative z-10 container mx-auto px-4 text-center">
        <div className="max-w-5xl mx-auto">
          {/* Alpine Badge */}
          <div className="inline-flex items-center px-6 py-3 rounded-full border border-primary/30 bg-primary/10 backdrop-blur-sm mb-8 animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
          ...
          <h1 className="text-6xl md:text-8xl font-luxury text-white mb-8 leading-tight">
            ...
            <span className="block text-primary animate-fade-in-up" style={{ animationDelay: '0.6s' }}>
              EVEN'T
            </span>
          </h1>
          
          {/* Dynamic Subheading */}
          <p className="text-2xl md:text-3xl text-white/95 mb-6 font-elegant leading-relaxed animate-fade-in-up" style={{ animationDelay: '0.8s' }}>
            {heroSlides[currentSlide].subtitle}
          </p>
          
          {/* Description with Enhanced Styling */}
          <p className="text-lg md:text-xl text-white/85 mb-12 max-w-3xl mx-auto font-elegant leading-relaxed animate-fade-in-up" style={{ animationDelay: '1s' }}>
          ...
          {/* Stats Section */}
          <div className="mt-16 grid grid-cols-3 gap-8 max-w-2xl mx-auto animate-fade-in-up" style={{ animationDelay: '1.4s' }}>
